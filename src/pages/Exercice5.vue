...
// Propriété calculée pour afficher le nombre de caractères saisis
const nombreCaractere = computed(() => userInput.value.length);

// Watcher pour détecter "Pokémon" (insensible à la casse) et réinitialiser la saisie si la limite est dépassée
